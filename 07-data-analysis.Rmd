...
## Integrating farmer-generated data and agro-climatic data for crop variety selection"
...
``` {r starting, message = FALSE, eval = FALSE, echo = FALSE}
library("gosset")
...
```{r rankings, message = FALSE, eval = FALSE, echo = FALSE}
...
```{r kendall1, message=FALSE, eval = FALSE, echo = FALSE}
...
```{r kendall2, message=FALSE, eval = FALSE, echo=FALSE}
...
```{r PLmodel, message=FALSE, eval = FALSE, echo = FALSE}
...
```{r worthmap, message=FALSE, eval = FALSE, echo = FALSE}
...
```{r chirps, message=FALSE, eval=FALSE, echo = FALSE}
...
```{r chirps2, message=FALSE, eval = FALSE, echo=FALSE}
...
```{r chirps3, message=FALSE, eval = FALSE, echo = FALSE}
...
```{r grouped_ranking, message=FALSE, eval = FALSE, echo = FALSE}
...
```{r pltree, message=FALSE, eval = FALSE, echo = FALSE}
pldG = cbind(G, rain)
...
```{r node_info, message=FALSE, eval = FALSE, echo = FALSE}
node_labels(tree)
...
```{r node_info2, message=FALSE, eval = FALSE,echo = FALSE}
...
```{r rel1, message=FALSE, eval=FALSE, echo = FALSE}
reliability(tree, ref = "Amadeus 77")
```

```{r rel2, message=FALSE, eval = FALSE, echo=FALSE}
...
```{r compare, message=FALSE, echo = FALSE, eval = FALSE, out.width="50%"}
